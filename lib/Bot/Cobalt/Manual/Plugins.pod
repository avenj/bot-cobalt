...
Bot::Cobalt::Manual::Plugins - Cobalt2 plugin-writing fundamentals guide
...
See L<Bot::Cobalt::Manual::PluginConf> for more about YAML and plugin configs.
...
('Main' context) IRC plugin provided by L<Bot::Cobalt::IRC>, followed by 
...
See L<Bot::Cobalt::IRC> for a list of IRC events and their event syntax.
...
L<Bot::Cobalt::Core> is an instanced singleton; loaded plugins can always 
...
All plugin load/unload frontends should make use of the Bot::Cobalt::Core 
