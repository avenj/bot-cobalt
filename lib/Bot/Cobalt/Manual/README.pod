...
This section will likely be moved out to Bot::Cobalt::Manual:: namespace soon.
...
configuration for the core single-server IRC plugin, L<Bot::Cobalt::IRC>.
...
The format is:
  ...
  ---
  <PluginName>:
    Module: Bot::Cobalt::Plugin::<Module>
