...
See L<Cobalt::IRC::Message> and L<Cobalt::IRC::Message::Public> for the 
complete documentation regarding message object methods. The most 
...
command. B<< $msg->message_array_sp >> remains unchanged.
