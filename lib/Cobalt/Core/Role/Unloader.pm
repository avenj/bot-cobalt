package Cobalt::Core::Role::Unloader;
...
Cobalt::Core::Role::Unloader - Plugin unloader role for Cobalt::Core
...
This is a L<Moo::Role> consumed by L<Cobalt::Core>.

These methods are used by plugin managers such as 
L<Cobalt::Plugin::PluginMgr> to handle plugin reloads.
